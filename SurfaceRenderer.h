...
class SurfaceRenderer:public GLObject
	...
	struct DataItem:public GLObject::DataItem
		...
		GLint heightMapShaderUniforms[17];//[16]; // Locations of the height map shader's uniform variables
		...
		GLint globalAmbientHeightMapShaderUniforms[13]; //14 with modification, Locations of the global ambient height map shader's uniform variables
